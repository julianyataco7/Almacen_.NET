<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WF_CrearUsu.aspx.cs" Inherits="Practicando_parcial.Views.Cuentas.WF_CrearUsu" MasterPageFile="~/Site1.Master" %>
             ...
             <div class="form-group form-check">
                ...
                <div class="d-flex justify-content-between">
                    <asp:Button ID="BtnRegistrar" runat="server" Text="Crear Usuario" CssClass="btn btn-primary"  style="margin-top: 8px;"/>
                      <button id="BtnRedirect" class="btn btn-primary mb-3" >Ir a Login</button>
                    <asp:Button ID="BtnSeguridad" runat="server" Text="Crear Usuario Seguridad" CssClass="btn btn-primary" OnClick="BtnRegister_Click" style="margin-top: 8px;"/>
                </div>
                     ...
                     if (response.success) {
                         ...
                         $("#jqGrid").jqGrid({
                             ...
                             colModel: [
                                 ...
                                 { label: "CONTRASEÑA", name: "contraseña", width: 150 },
                ...
                e.preventDefault();
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            $("#jqGrid").jqGrid('addRowData', response.registroNew.id_usuario, response.registroNew);
